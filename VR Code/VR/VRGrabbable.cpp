...
//Give back Quat and check if left or right hand.
Quat VRGrabbable::getEntityAngleOffset(Ang3 handRotation, bool leftHand) {
	...
	return (Quat(Matrix33::CreateRotationXYZ(FinalOffset))); // returns quat for rotating entities
}
//return the positional offset for grabbing an entity
